...
if (strlen($_SESSION['alogin']) == 0) {
  ...
  if (isset($_POST['NaEBTN'])) {
    ...
    $status = '1';
    $sql = "INSERT INTO news(heading,content,date,image,category,activeStatus,landingStatus) VALUES ('" . $title . "','" . $content . "','" . $date . "','" . $image . "','" . $category . "','" . $status . "','" . $homePageShow . "')";
    // print_r($sql);
    // exit();
    $query = $dbh->prepare($sql);
    $result = $query->execute();
    if ($query->rowCount() > 0) {
      $_SESSION["eventAdd"] = "success";
      echo '<script>window.location = "index.php";</script>';
    } else {
      $_SESSION["eventAdd"] = "notsuccess";
      echo '<script>window.location = "index.php";</script>';
    }
  } ?>
...
>
  <head>
    ...
    <title>Create News and Events  | MetaValley TBI</title>
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <span class="text-muted fw-light">Admin / </span>Create New News &amp; Events</h4>
