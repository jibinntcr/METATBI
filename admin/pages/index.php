    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <a href="crate-news-and-events.php"  class="float-end btn btn-primary">New</a>
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Admin / </span>News &amp; Events</h4>
                  ...
                  <table class="table">
                    ...
                    ?>
                      ...
                      ?>
                        ...
                        $cat = $result->category;
                        if ($cat == 'News') { ?>
                        <td><span class="badge bg-label-success me-1"><?php echo $cat ?></span></td>
                            <?php } elseif ($cat == 'Events') { ?>
                        <td><span class="badge bg-label-info me-1"><?php echo $cat ?></span></td>
                           <?php  }
                            ?>
                            <?php
                        ...
                        <td>
                            ...
                            <input onclick="location.href ='eventActivate.php?idE=<?php echo $idE ?>';"
                        ...
                        <td>
                            <div class="form-check form-switch ">
                            <input onclick="location.href ='eventActivate.php?idD=<?php echo $idD ?>';"
                            ...
                            ?>
                            <td>
                         <a  onclick="location.href = 'events-edit.php?id=<?php echo   $result->id ?>';" class="dropdown-item" href="javascript:void(0);"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                        </td>
                      </tr>
                        <?php }
                    }
